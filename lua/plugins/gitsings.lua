return {
  ...
  opts = {
    on_attach = function(bufnr)
      ...
      map("v", "<leader>zs", function() gs.stage_hunk { vim.fn.line ".", vim.fn.line "v" } end, "Stage hunk")
      map("v", "<leader>zr", function() gs.reset_hunk { vim.fn.line ".", vim.fn.line "v" } end, "Reset hunk")
      ...
      map("n", "<leader>zb", function() gs.blame_line { full = true } end, "Blame line")
      map("n", "<leader>zB", gs.toggle_current_line_blame, "Toggle line blame")

      map("n", "<leader>zd", gs.diffthis, "Diff this")
      map("n", "<leader>zD", function() gs.diffthis "~" end, "Diff this ~")
